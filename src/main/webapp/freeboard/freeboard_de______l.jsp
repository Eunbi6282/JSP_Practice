...
<SCRIPT language = "javascript">
	function check(){
		with(document.msgdel){  //document : 전체 페이지 msgdel : 폼내용
...
<link hred = "freeboard.css" rel = "sytlesheet" type = "text/css">
...
<body>
	...
	<center>
		...
		<!-- hidden : 출력은 하지 않지 않으면서 변수의 값을 다른 페이지로 넘길 때
			id 변수와 page변수의 값을 처리
		 -->
